...
class DetailViewController: UIViewController {
    ...
    func configureView() {
        ...
        if let missionPatch = launch.mission?.missionPatch, let url = URL(string: missionPatch) {
          self.missionPatchImageView.sd_setImage(with: url, placeholderImage: placeholder)
        } else {
